...
def forward_request(data, upstream_dns='8.8.8.8', upstream_port=53):
    # Criar socket UDP para enviar ao servidor DNS
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="DNS Forwarder - Etapa 3")
